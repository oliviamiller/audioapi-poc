...
func RegisterAudioServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AudioServiceClient) error {
	mux.Handle(http.MethodPost, pattern_AudioService_Record_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/olivia.service.audio.v1.AudioService/Record", runtime.WithHTTPPathPattern("/olivia/api/v1/service/audio/{name}/record"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
